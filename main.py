...
#Semaforo 2
led_verm_2 = Pin(5, Pin.OUT)
led_amr_2 = Pin(17, Pin.OUT)
led_vrd_2 = Pin(16, Pin.OUT)

#botoes
btn_start_verde = Pin(19, Pin.IN, Pin.PULL_UP)
btn_stop_vermelho = Pin(18, Pin.IN, Pin.PULL_UP)
